...
import juitar.gwrexpansions.client.render.MirecallerBombBulletRenderer;
...
final class ClientSetupMYF {
    ...
    static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(GWREEntities.MIRECALLER_BOMB_BULLET.get(), MirecallerBombBulletRenderer::new);
