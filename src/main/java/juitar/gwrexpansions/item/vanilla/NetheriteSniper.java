...
public class NetheriteSniper extends ConfigurableGunItem implements GeoItem {
    private static final String NBT_GECKO_FIRING = "NetheriteSniperGeckoFiring";
    private static final String NBT_GECKO_ANIMATION_SEQUENCE = "NetheriteSniperGeckoAnimationSequence";
    private static final String GECKO_CONTROLLER = "controller";
    private static final int FIRE_ANIM_TICKS = 13; // 0.625s at 20 tps
    ...
    public NetheriteSniper(Properties properties, int bonusDamage, double damageMultiplier, int fireDelay,
    ...
    private static void ensureGeckoId(ItemStack stack, Level level) {
        if (stack.isEmpty() || !(stack.getItem() instanceof NetheriteSniper) || !(level instanceof ServerLevel serverLevel)) {
            return;
        }
    ...
    private static void restartAnimationIfSequenceChanged(AnimationState<NetheriteSniper> state,
