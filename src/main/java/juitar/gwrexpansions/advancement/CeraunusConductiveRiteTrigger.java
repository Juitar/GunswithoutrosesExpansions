...
public class CeraunusConductiveRiteTrigger extends SimpleCriterionTrigger<CeraunusConductiveRiteTrigger.TriggerInstance> {

    private static final ResourceLocation ID = new ResourceLocation(GWRexpansions.MODID, "ceraunus_conductive_rite");
    ...
    public static void onCeraunusConductiveRite(ServerPlayer player) {
        GWRECriteria.CERAUNUS_CONDUCTIVE_RITE.trigger(player);
    }
