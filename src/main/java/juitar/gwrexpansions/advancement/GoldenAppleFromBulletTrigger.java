...
public class GoldenAppleFromBulletTrigger extends SimpleCriterionTrigger<GoldenAppleFromBulletTrigger.TriggerInstance> {

    private static final ResourceLocation ID = new ResourceLocation(GWRexpansions.MODID, "golden_apple_from_bullet");
     ...
     * 当金弹丸碎裂出金苹果时调用此方法
     */
    public static void onGoldenAppleFromBullet(ServerPlayer player) {
        GWRECriteria.GOLDEN_APPLE_FROM_BULLET.trigger(player);
    }
