...
public class KubeJSGunItem extends GunItem implements GunSkillItem {
    ...
    protected void shoot(Level level, Player player, ItemStack gun, ItemStack ammo, IBullet bullet, boolean bulletFree) {
        GunProjectileSupport.shoot(this, level, player, gun, ammo, bullet, bulletFree, conversion, pierceCount, ammoConversions);
    }
