...
public class KubeJSGunItem extends GunItem implements GunSkillItem, KubeJSGunEventSource {
    ...
    public KubeJSGunItem(Properties properties, AbstractKubeJSGunBuilder builder) {
        super(properties, builder.bonusDamage, builder.damageMultiplier, builder.fireDelay, builder.inaccuracy, builder.enchantability);
    ...
    @Override
    protected void shoot(Level level, Player player, ItemStack gun, ItemStack ammo, IBullet bullet, boolean bulletFree) {
        GunProjectileSupport.shoot(this, level, player, gun, ammo, bullet, bulletFree, conversion, pierceCount, ammoConversions, callbacks);
    }
