...
public class CompatCataclysm {
        public static RegistryObject<GunItem> ignitium_gatling, cursium_sniper, netherite_monster_shotgun, tidal_pistol,
                        harbinger_raycaster, remnant_fangshot, ceraunus_burst;
        ...
        public static void registerItems() {
                ...
                netherite_monster_shotgun = GWREItems.initItem(
                                () -> new LavapowerGunItem(
                                                GWREItems.defP().durability(10000).fireResistant().rarity(Rarity.EPIC),
                                                0, 0.8, 25, 4.0, 20,
                                                () -> GWREConfig.SHOTGUN.NetheriteMonster).projectiles(5)
                                                .fireSound(GWRSounds.shotgun)
                                                .repair(() -> Ingredient.of(MONSTROUS_HORN.get())),
                ...
                ignitium_bullet = GWREItems.initItem(() -> new IgnitiumBulletItem(GWREItems.defP().fireResistant(), 12),
                                "ignitium_bullet");
                lavapower_bullet = GWREItems.initItem(
                                () -> new LavapowerBulletItem(GWREItems.defP().fireResistant(), 9), "lavapower_bullet");
                cursium_bullet = GWREItems.initItem(() -> new CursiumBulletItem(GWREItems.defP().fireResistant(), 14),
                                "cursium_bullet");
                tidal_bullet = GWREItems.REG.register("tidal_bullet",
                                () -> new TidalBulletItem(GWREItems.defP().fireResistant(), 12));
                ...
                remnant_fangshot = GWREItems.initItem(() -> new RemnantFangshotItem(
                                ...
                                .projectiles(4).fireSound(GWRSounds.shotgun)
                                .repair(() -> Ingredient.of(ANCIENT_METAL_INGOT.get())),
                                "remnant_fangshot");
