...
public class CompatCataclysm {
    ...
    public static void registerItems() {
        ...
        netherite_monster_shotgun = GWREItem.initItem( () -> new LavapowerGunItem(GWREItem.defP().durability(10000).fireResistant(),0,0.8,25,2,20,() -> GWREConfig.SHOTGUN.netheriteMonster).projectiles(5).fireSound(GWRSounds.shotgun),"netherite_monster_shotgun");
        cursium_sniper = GWREItem.initItem( () -> new CursiumGunItem(GWREItem.defP().durability(10000).fireResistant(),0,2,25,0,20,() -> GWREConfig.SNIPER.cursium).projectileSpeed(4).headshotMult(1.5).fireSound(GWRSounds.sniper),"cursium_sniper");
        ignitium_gatling = GWREItem.initItem( () -> new IgnitiumGatlingItem(GWREItem.defP().durability(10000).fireResistant(),4,1,4,3,20,() -> GWREConfig.GATLING.ignitium),"ignitium_gatling");
