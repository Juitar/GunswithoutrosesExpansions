...
public class VanillaItem {
    ...
    public static RegistryObject<BulletItem> slime_bullet, diamond_bullet, netherite_bullet, golden_bullet,
            copper_bullet, redstone_bullet, maws_of_gluttony, hunger_bullet;
    ...
    public static void registerItems() {
        ...
        netherite_bullet = GWREItems.initItem(() -> new ReshotableBulletItem(GWREItems.defP().fireResistant(), 8),
                "netherite_bullet");
        maws_of_gluttony = GWREItems.initItem(() -> new HungerBulletItem(GWREItems.defP().fireResistant(), 5),
                "maws_of_gluttony");
        diamond_bullet_shrapnel = GWREItems.REG.register("diamond_bullet_shrapnel",
                () -> new PiercingBulletItem(GWREItems.defP(), 3, 2));
        hunger_bullet = GWREItems.REG.register("hunger_bullet",
                () -> new BulletItem(GWREItems.defP().fireResistant(), 5));
